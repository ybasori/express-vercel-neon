...
export const fetchPublicBlogContentDetail = createAsyncThunk(
  "publicBlogContentDetail/fetchPublicBlogContentDetail",
  async (
    {
      page,
      sort,
    ...
    try {
      ...
      const data = await fetch(`${api.PUBLIC_BLOG_CONTENT_LIST}?${query}`, {
        method: "GET",
        headers: {
