...
export const fetchPublicBlogCategory = createAsyncThunk(
  "publicBlogCategory/fetchPublicBlogCategory",
  async (
    {
      page,
      sort,
    ...
    try {
      ...
      const data = await fetch(`${api.PUBLIC_BLOG_CATEGORY_LIST}?${query}`, {
        method: "GET",
        headers: {
